...
const title = "Song Management Database";
...
const themeData = {
    ...
    components: {
        ...
        MuiButton: {
            variants: [{props: { color: 'secondary' }, style: { backgroundColor: '#00f557',color: '#ffffff','&:hover': {backgroundColor: '#11c762',},},},],
        }
    },
};
...
const shownGenres = ['ROCK', 'POP', 'HIP-HOP', 'RAP', 'R&B', 'SOUL', 'METAL', 'PUNK', 'ALTERNATIVE', 'SOUNDTRACK', 'OTHER'];

const shownAttributes = ['artist', 'title', 'album', 'genre', 'duration'];
